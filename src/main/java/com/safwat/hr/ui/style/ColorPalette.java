...
public final class ColorPalette {
    ...
    public static Color primary() {
        return Color.web(Theme.PRIMARY);
    }

    public static Color primaryLight() {
        return Color.web(Theme.PRIMARY_LIGHT);
    }

    public static Color success() {
        return Color.web(Theme.SUCCESS);
    }

    public static Color warning() {
        return Color.web(Theme.WARNING);
    }

    public static Color error() {
        return Color.web(Theme.ERROR);
    }

    public static Color info() {
        return Color.web(Theme.INFO);
    }
