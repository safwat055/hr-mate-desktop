package com.safwat.hr.controller.payroll.table;

import com.safwat.hr.controller.payroll.table.PayrollApiClient.LookupResult;
...
public class TableController implements Initializable {
    ...
    // ---- أزرار ----
    @FXML
    private Button btn_Excel, btn_setting;
    @FXML
