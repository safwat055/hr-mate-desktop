...
@PayrollReport(
        code = "DETAILS_ELEMENT_CODE_EMPLOYEE",
        displayName = "عنصر بالكود الاقتصادي لموظف",
        category = "DETAILS_ELEMENT_CODE",
        mainReport = "DETAILS_ELEMENT_CODE"
)
public class ElementCodeEmployeeDetails implements ReportStrategy {
    @Override
    public String getCode() {
        return "DETAILS_ELEMENT_CODE_EMPLOYEE";
    }

    @Override
    public String getDisplayName() {
        return "عنصر بالكود الاقتصادي لموظف";
    }
