...
@PayrollReport(
        code = "DETAILS_ELEMENT_CODE_EMPLOYEES",
        displayName = "عنصر بالكود الاقتصادي لكل الموظفين",
        category = "DETAILS_ELEMENT_CODE",
        mainReport = "DETAILS_ELEMENT_CODE"
)
public class ElementCodeEmployeesDetails implements ReportStrategy {
    @Override
    public String getCode() {
        return "DETAILS_ELEMENT_CODE_EMPLOYEES";
    }

    @Override
    public String getDisplayName() {
        return "عنصر بالكود الاقتصادي لكل الموظفين";
    }
