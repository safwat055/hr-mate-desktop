...
@PayrollReport(
        code = "TOTAL_ELEMENT_CODE_PAY_GROUP",
        displayName = "عنصر بالكود الاقتصادي لمجموعة تعيين محددة إجمالي",
        category = "TOTAL_ELEMENT_CODE",
        mainReport = "TOTAL_ELEMENT_CODE"
)
public class ElementCodePayGroupTotal implements ReportStrategy {
    @Override
    public String getCode() {
        return "TOTAL_ELEMENT_CODE_PAY_GROUP";
    }

    @Override
    public String getDisplayName() {
        return "عنصر بالكود الاقتصادي لمجموعة تعيين محددة إجمالي";
    }
