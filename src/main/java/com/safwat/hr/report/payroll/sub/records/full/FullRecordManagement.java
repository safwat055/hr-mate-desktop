...
@PayrollReport(
        code = "FULL_RECORD_MANAGEMENT",
        displayName = "سجل 129 كامل لكل لادارة محددة",
        category = "FULL_RECORD",
        mainReport = "FULL_RECORD"
)
public class FullRecordManagement implements ReportStrategy {
    @Override
    public String getCode() {
        return "FULL_RECORD_MANAGEMENT";
    }

    @Override
    public String getDisplayName() {
        return "سجل 129 كامل لكل لادارة محددة";
    }
    ...
    public void validate(ReportContext context) {
        ...
        if (context.getManagement() == null || context.getManagement().isBlank()) {
            throw new ValidationException("الادارة مطلوبة");
        }
    }
}
