...
@PayrollReport(
        code = "DETAILS_ELEMENT_EMPLOYEES",
        displayName = "عنصر تفصيلي لكل الموظفين",
        category = "DETAILS_ELEMENT",
        mainReport = "DETAILS_ELEMENT"
)
public class ElementEmployeesDetails implements ReportStrategy {
    @Override
    public String getCode() {
        return "DETAILS_ELEMENT_EMPLOYEES";
    }

    @Override
    public String getDisplayName() {
        return "عنصر تفصيلي لكل الموظفين";
    }
