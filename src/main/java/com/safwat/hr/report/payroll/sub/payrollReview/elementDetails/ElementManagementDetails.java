...
@PayrollReport(
        code = "DETAILS_ELEMENT_MANAGEMENT",
        displayName = "عنصر تفصيلي لادارة محددة",
        category = "DETAILS_ELEMENT",
        mainReport = "DETAILS_ELEMENT"
)
public class ElementManagementDetails implements ReportStrategy {
    @Override
    public String getCode() {
        return "DETAILS_ELEMENT_MANAGEMENT";
    }

    @Override
    public String getDisplayName() {
        return "عنصر تفصيلي لادارة محددة";
    }
