 ...
 * عبر {@link com.safwat.hr.report.payroll.strategies.ReportStrategyRegistry}.
 *
 * <p><b>التطور المستقبلي المقترح:</b> يمكن استخدامها مع Reflection
 * لتسجيل الاستراتيجيات تلقائيًا في الـ Registry دون الحاجة
 * لإضافة سطر يدوي في {@link com.safwat.hr.report.payroll.strategies.ReportRegistryFactory}.
 * مثال:
 * <pre>{@code
 ...
 *
 * @see com.safwat.hr.report.payroll.strategies.ReportStrategy
 * @see com.safwat.hr.report.payroll.strategies.ReportRegistryFactory
 */
