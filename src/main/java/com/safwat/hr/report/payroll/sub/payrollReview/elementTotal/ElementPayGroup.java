package com.safwat.hr.report.payroll.sub.payrollReview.elementTotal;
...
@PayrollReport(
        code = "TOTAL_ELEMENT_PAY_GROUP",
        displayName = "عنصر لمجموعة تعيين",
        category = "TOTAL_ELEMENT",
        mainReport = "TOTAL_ELEMENT"
)
public class ElementPayGroup implements ReportStrategy {
    @Override
    public String getCode() {
        return "TOTAL_ELEMENT_PAY_GROUP";
    }
