...
@PayrollReport(
        code = "SHORT_RECORD_PAY_GROUP",
        displayName = "سجل 129 مختصر لكل لمجموعة تعيين محددة",
        category = "SHORT_RECORD",
        mainReport = "SHORT_RECORD"
)
public class ShortRecordPayGroup implements ReportStrategy {
    @Override
    public String getCode() {
        return "SHORT_RECORD_PAY_GROUP";
    }

    @Override
    public String getDisplayName() {
        return "سجل 129 مختصر لكل لمجموعة تعيين محددة";
    }
