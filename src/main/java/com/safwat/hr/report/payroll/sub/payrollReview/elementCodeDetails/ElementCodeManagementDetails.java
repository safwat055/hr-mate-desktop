...
@PayrollReport(
        code = "DETAILS_ELEMENT_CODE_MANAGEMENT",
        displayName = "عنصر بالكود الاقتصادي لإدارة محددة",
        category = "DETAILS_ELEMENT_CODE",
        mainReport = "DETAILS_ELEMENT_CODE"
)
public class ElementCodeManagementDetails implements ReportStrategy {
    @Override
    public String getCode() {
        return "DETAILS_ELEMENT_CODE_MANAGEMENT";
    }

    @Override
    public String getDisplayName() {
        return "عنصر بالكود الاقتصادي لإدارة محددة";
    }
